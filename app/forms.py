...
from wtforms import StringField,BooleanField,PasswordField,SubmitField,ValidationError,TextField,TextAreaField,SelectField#the field class that we are going to use/import from the flask package wtform module module
...
class PitchForm(FlaskForm):
    '''
    class to create pitches    
    '''
    title = StringField('Pitch Title',validators=[DataRequired()])
    # category =SelectField(u'Pitch Category', choices=[('tech', 'tech'), ('coding', 'coding'), ('sport', 'sport')])
